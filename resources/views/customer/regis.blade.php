      ...
      <form action="/login" method="post">
        ...
        <div class="container">
          ...
          <div class="input-field">
            <input type="text" class="input" placeholder="Nama" name="email" />
            <i class="bx bx-user"></i>
          </div>
          <div class="input-field">
            <input type="password" class="input" placeholder="Email" name="password" />
          ...
          <div class="input-field">
            <input type="submit" class="submit" value="Registrasi" name="login_btn" />
          </div>

          <div class="bottom">
            <div class="left">
              
              <label for="check">Have an account? <a href="login" style="font-weight: bold">Login</a></label>
            </div>
          </div>
        </div>
      </form>
