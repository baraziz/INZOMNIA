...
<style>
    select {
        appearance: none; outline: 0; box-shadow: none; border: 0!important; background:#000; background-image: none; flex: 1; padding: 0 .5em; color: #fff; cursor: pointer;
    }
    select::-ms-expand {
        display: none;
    }
    ...
    .select::after {
        content: '\25BC'; position: absolute;top: 0;right: 0;padding: 0 1em;background: #000;cursor: pointer;pointer-events: none;transition: .25s all
    }
    .select:hover::after{
        color: #23b499;
    }
